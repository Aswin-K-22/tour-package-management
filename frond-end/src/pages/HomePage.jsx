  ...
  const tourPackages = [
    {
      ...
      image: "https://images.unsplash.com/photo-1514282401047-d79a71fac224?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80",
      amount: "$799",
      buttonText: "View Package",
      buttonLink: "/packages/malaysia",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1515036551092-39b3e1fa4627?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80",
      amount: "$850",
      buttonText: "View Package",
      buttonLink: "/packages/singapore",
      duration: "4 Days",
      location: "Singapore",
      rating: 4.7
    }
  ...
  <div className="relative w-full h-full">
    {tourPackages.map((pkg, index) => (
      ...
      >
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-b from-black/30 to-black/60"></div> {/* Lighter, gradient overlay */}
        </div>
